...
chai.spy.on(global.domUpdates, ['displayPuzzle'], () => true);
...
describe('it should create a game ', function() {
  ...
  it('should return an array of puzzles', function() {
    ...
    expect(bankOfPuzzles[0]).to.be.instanceOf(Object);
    expect(bankOfPuzzles[0]).to.have.property('total_number_of_letters');
  });
